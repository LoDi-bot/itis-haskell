...
zipLongTests = testGroup "ZipLong Tests"
  ...
  , testCase "zipLong [1,2,3,4] \"ab\" = [(1,'a'),(2,'b'),(3,'a'),(4,'b')]" $ zipLong [1,2,3,4] "ab" @?= [(1,'a'),(2,'b'),(3,'a'),(4,'b')]
  , testCase "zipLong [1,2,3,4,5,6] \"ab\" = [(1,'a'),(2,'b'),(3,'a'),(4,'b'),(5, 'a'),(6, 'b')]" $ zipLong [1,2,3,4,5,6] "ab" @?= [(1,'a'),(2,'b'),(3,'a'),(4,'b'),(5, 'a'),(6, 'b')]
  , testCase "zipLong [1,2,3] \"abcde\" = [(1,'a'),(2,'b'),(3,'c'),(1,'d'),(2, 'e')]" $ zipLong [1,2,3] "abcde" @?= [(1,'a'),(2,'b'),(3,'c'),(1,'d'),(2, 'e')]
  , testCase "zipLong [] \"abcd\" = []" $ zipLong ([] :: [Int]) "abcd" @?= []
  , testCase "zipLong \"abcd\" [] = []" $ zipLong "abcd" ([] :: [Int]) @?= []
  ]
...
traversalTests = testGroup "traversal function"
  [ testCase "empty" $ traversal empty @?= ([] :: [Int])
  , testCase "single elt" $ traversal (Node Nothing 1 Nothing) @?= [1]
  , testCase "three elts" $ traversal (Node (Just $ leaf 1) 2 (Just $ leaf 3)) @?= [1,2,3]
  ]

insertTests :: TestTree
insertTests = testGroup "insert function"
...
rotateTests = testGroup "rotate function"
